...
public class OperationsLinechart implements IProcessVisualizer {
    ...
    private void render() {
        ...
        // Create the chart
        JFreeChart chart = ChartFactory.createXYLineChart("Wahrscheinlichkeiten der Operator for Solomon-Instance", "i", "p", data, PlotOrientation.VERTICAL, true, true, false);
